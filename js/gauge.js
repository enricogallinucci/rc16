    ...
    Gauge.prototype.render = function() {
      ...
      if (this.options.customFillStyle !== void 0) {
        ...
        if (this.options.gradientType === 0) {
          ...
          fillStyle = this.ctx.createLinearGradient(0, 0, w*2, 0);
        }
        fillStyle.addColorStop(0, this.options.colorStart);
        fillStyle.addColorStop(0.3, this.options.colorStart);//LOLLO
        fillStyle.addColorStop(0.5, "#FFFFFF");//LOLLO
        fillStyle.addColorStop(0.7, this.options.colorStop);//LOLLO
      ...
      this.ctx.stroke();
      //this.ctx.strokeStyle = this.options.strokeColor; //LOLLO - originale
      this.ctx.strokeStyle = fillStyle;
      this.ctx.beginPath();
