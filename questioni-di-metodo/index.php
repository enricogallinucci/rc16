...
<body id="level1-page">
	...
	<div class="container">
		...
		<div id="vc-helper" style="display:none">
			<p>
				Seleziona un argomento di discussione per visualizzare le seguenti informazioni:<br>
				- QUESTIONE: descrive brevemente l'argomento di discussione.<br>
				...
				Dopo aver considerato le opinioni, aziona il pulsante azzurro per esprimere la tua (eventuale) vicinanza alle ragioni del SI o del NO.
			</p>
		</div>
